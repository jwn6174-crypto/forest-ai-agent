...
def sentinel2_ndvi_timeseries(
    ...
    return {
        ...
        "lat": lat, "lon": lon, "buffer_m": radius_m,
...
def triangulate_validation_case(
    ...
    lat: float, lon: float,
    *,
    nfi_estimate_tco2_per_ha: float = None,
    model_estimate_tco2_per_ha: float = None,
    certified_tco2_per_ha: float = None,
) -> Dict:
    """
...
PLAN_B_VALIDATION_CASES = {
    "FCR_43_BOEUN_001": {
        "lat": 36.5841, "lon": 127.7344,
        "lot_id": "충청북도 보은군 산외면 오대리 산39 외 2필지",
        "certified_tco2": 8197, "area_ha": 25.6,
    },
    "FCR_43_BOEUN_002": {
        "lat": 36.5878, "lon": 127.7348,
        "lot_id": "충청북도 보은군 산외면 원평리 11 외 11필지",
        "certified_tco2": 63658, "area_ha": 198.9,
    },
    "FCR_45_JINAN_003": {
        "lat": 35.9799, "lon": 127.4676,
        "lot_id": "전라북도 진안군 용담면 와룡리 산48 외 1필지",
        "certified_tco2": 4671, "area_ha": 14.6,
    },
    "FCR_45_JINAN_001": {
        "lat": 35.8984, "lon": 127.5294,
        "lot_id": "전라북도 진안군 상전면 구룡리 산122 외 6필지",
        "certified_tco2": 18063, "area_ha": 56.4,
    },
}
