...
넷째, **시장이 막 변곡점에 다다랐다.** KAU 배출권 가격이 저점(2025-07 8,670원)에서
2026-03 15,550원까지 16개월 +79.4% 급등하며, 산주의 의향가격(WTA 17,039원) 돌파를
8.7%(1,489원) 앞두고 있다(D115, 아직 미돌파·돌파 임박). 이 hurdle 을 넘는
...
| ID | 발견 | 추정 편향 |
|---|---|---|
| D114 | 산림탄소상쇄 인증실적이 자연 성장 모델보다 +45% 높다 | 인증 = 과대 |
| D115 | KAU 가 16개월 +79.4%, WTA 의향가격 돌파 임박(8.7% 미달) | 시장 변곡점 |
